...
namespace ContactBook {
    ...
    public partial class TestDataSet : global::System.Data.DataSet {
        ...
        public partial class ContactsDataTable : global::System.Data.TypedTableBase<ContactsRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public ContactsRow AddContactsRow(string FName, string LName, string Street, string City, string Province, string PostalCode, string Phone, string Email) {
        ...
        public partial class ContactsRow : global::System.Data.DataRow {
            ...
            public string Street {
                get {
                    try {
                        ...
                        throw new global::System.Data.StrongTypingException("The value for column \'Street\' in table \'Contacts\' is DBNull.", e);
                    }
                }
                set {
            ...
            public void SetStreetNull() {
                this[this.tableContacts.StreetColumn] = global::System.Convert.DBNull;
            }
...
namespace ContactBook.TestDataSetTableAdapters {
    ...
    public partial class ContactsTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [dbo].[Contacts] WHERE (([Id] = @Original_Id) AND ([FName] = @Original_FName) AND ([LName] = @Original_LName) AND ((@IsNull_City = 1 AND [City] IS NULL) OR ([City] = @Original_City)) AND ((@IsNull_Province = 1 AND [Province] IS NULL) OR ([Province] = @Original_Province)) AND ((@IsNull_PostalCode = 1 AND [PostalCode] IS NULL) OR ([PostalCode] = @Original_PostalCode)) AND ((@IsNull_Phone = 1 AND [Phone] IS NULL) OR ([Phone] = @Original_Phone)) AND ((@IsNull_Email = 1 AND [Email] IS NULL) OR ([Email] = @Original_Email)))";
            ...
            this._adapter.InsertCommand.CommandText = @"INSERT INTO [dbo].[Contacts] ([FName], [LName], [Street], [City], [Province], [PostalCode], [Phone], [Email]) VALUES (@FName, @LName, @Street, @City, @Province, @PostalCode, @Phone, @Email);
SELECT Id, FName, LName, Street, City, Province, PostalCode, Phone, Email FROM Contacts WHERE (Id = SCOPE_IDENTITY())";
...
SELECT Id, FName, LName, Street, City, Province, PostalCode, Phone, Email FROM Contacts WHERE (Id = @Id)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::ContactBook.Properties.Settings.Default.TestConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Id, FName, LName, Street, City, Province, PostalCode, Phone, Email FROM db" +
                "o.Contacts";
        ...
        public virtual int Delete(int Original_Id, string Original_FName, string Original_LName, string Original_City, string Original_Province, string Original_PostalCode, string Original_Phone, string Original_Email) {
        ...
        public virtual int Insert(string FName, string LName, string Street, string City, string Province, string PostalCode, string Phone, string Email) {
            if ((FName == null)) {
        ...
        public virtual int Update(
                    ...
                    string Original_Phone, 
                    string Original_Email) {
            return this.Update(FName, LName, Street, City, Province, PostalCode, Phone, Email, Original_Id, Original_FName, Original_LName, Original_City, Original_Province, Original_PostalCode, Original_Phone, Original_Email, Original_Id);
        }
    }
